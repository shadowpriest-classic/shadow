...
- Update version in 3 places when making changes:
  1. Footer: `<div class="version-label">v2.46.0</div>`
  2. App bar: `<span class="app-version">v2.46.0</span>`
...
#### Mind Flay Clipping Analysis (v2.45.0 → v2.46.0)
...
- ✅ v2.46.0: **Bug fix** - Filter out MF → MF attachment intervals and handle casts with no ticks
